        ...
        <div class="row align-items-center">
            <div class="col">
                <div class="footer__logo">
                    <img src="{{ asset('image/logos/nutricare.png') }}" alt="Gainioz Logo" class="footer__logo__image">
                </div>
            </div>
            <div class="col">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-2 col-md-4 mb-30">
                        <div class="footer__widget">
                            ...
                            <div class="footer__menu">
                                <ul>
                                    <li><a href="{{ route('donation') }}">Donasi Sekarang</a></li>
                        ...
                        <form action="#" method="post" class="footer__newsletter">
                            ...
                            <div class="footer__newsletter__formGroup">
                                <input id="agree" type="checkbox"
                                    class="footer__newsletter__check form-check-input">
                                <label class="footer__newsletter__label" for="agree">I agree that my submitted data
                                    is
                                    being
...
<div id="template-search" class="template-search">
    ...
    <form class="search-form" action ="{{ route('cariKampanye') }}" method="get">
        <input type="search" value="cari" name="cari" placeholder="Type your search" />
